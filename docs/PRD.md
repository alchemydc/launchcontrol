...
- **RMsolo** — the second ingest pipeline: results are scraped/parsed from published PDFs rather than a timing-software export. Parsing is league-agnostic; ingest is league-targeted.
