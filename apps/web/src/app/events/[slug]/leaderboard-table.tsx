...
// Overall-PAX standings view (PAX_STANDINGS=1): all classes, ranked by
// PAX-indexed best time instead of raw. Sentinel lives beside ALL_CLASSES so
// the two "virtual filters" stay obviously paired.
