...
//
// Output: tests/fixtures/season-event-{1..6}.axdb (gitignored — regenerated by `pnpm pretest`).
//
// The data is entirely synthetic — see feedback_sensitive_axdb_fixtures memory.
//
// Ingest reads one event per .axdb file. We create 6 separate files (one per
// season event) so the test can ingest all 6 and call buildSeasonLeaderboard.
...
// CS: Cam=57000, Fred=62000 ("boxster s" lowercase — normalization test), Gina=58000 (911)
buildEventAxdb(
  "season-event-1.axdb",
  "Season Event 1",
  "2026-03-01",
  ...
  [
    ...
    { driverId: 6, deltaMs: 62000, cones: 0 },
    { driverId: 7, deltaMs: 58000, cones: 0 },
  ],
);

// ─── Event 2: 2026-04-05 ─────────────────────────────────────────────────────
// C1: Alex=51000, Bea=53000, Dee=56000
// CS: Cam=58000, Fred=63000 (Boxster S), Gina=59000 (911)
buildEventAxdb(
  "season-event-2.axdb",
  "Season Event 2",
  "2026-04-05",
  ...
  [
    ...
    { driverId: 6, deltaMs: 63000, cones: 0 },
    { driverId: 7, deltaMs: 59000, cones: 0 },
  ],
);
...
//     Fred=64000ms (Cayman GT4 — his off-primary car; excluded from his season total)
//     Gina=60000ms (911)
buildEventAxdb(
  "season-event-3.axdb",
  "Season Event 3",
  ...
  [
    ...
    { id: 6, last: "Farr",   first: "Fred", num: "106", classId: 2, paxId: 2, memberNum: "MES-006", car: "Cayman GT4" }, // off-primary
    { id: 7, last: "Grant",  first: "Gina", num: "107", classId: 2, paxId: 2, memberNum: "MES-007", car: "911" },
  ],
  [
    ...
    { driverId: 6, deltaMs: 64000, cones: 0 }, // Cayman GT4 — excluded by single-car constraint
    { driverId: 7, deltaMs: 60000, cones: 0 },
  ],
...
// CS: Dee=62000 (off-class for Dee), Fred=65000 (Boxster S), Gina=80000 (Cayman)
buildEventAxdb(
  "season-event-4.axdb",
  "Season Event 4",
  "2026-06-14",
  ...
  [
    ...
    { driverId: 6, deltaMs: 65000, cones: 0 },
    { driverId: 7, deltaMs: 80000, cones: 0 },
  ],
);
...
//     Fred=66000 (Boxster S), Gina=81000 (Cayman)
buildEventAxdb(
  "season-event-5.axdb",
  "Season Event 5",
  "2026-07-19",
  ...
  [
    ...
    { driverId: 6, deltaMs: 66000, cones: 0 },
    { driverId: 7, deltaMs: 81000, cones: 0 },
  ],
);

// ─── Event 6: 2026-08-23 ─────────────────────────────────────────────────────
// C1: Alex=55000 (winner → 1000 pts), Bea=58000 (5th C1 entry)
// CS: Cam=DNF (exercises CLEAN filter again; 4th CS entry so still 3 scoring events)
//     Fred=67000 ("boxster s" — lowercase normalization test; same carKey as "Boxster S")
//     Gina=82000 (Cayman)
buildEventAxdb(
  "season-event-6.axdb",
  "Season Event 6",
  ...
  [
    ...
    { id: 2, last: "Barton", first: "Bea",  num: "102", classId: 1, paxId: 1, memberNum: "MES-002" },
    { id: 3, last: "Crane",  first: "Cam",  num: "103", classId: 2, paxId: 2, memberNum: "MES-003", car: "Porsche 911 GT3" },
    { id: 6, last: "Farr",   first: "Fred", num: "106", classId: 2, paxId: 2, memberNum: "MES-006", car: "Boxster S" }, // proper case; latest event → this is latestDescription
    { id: 7, last: "Grant",  first: "Gina", num: "107", classId: 2, paxId: 2, memberNum: "MES-007", car: "Cayman" },
  ],
  [
    { driverId: 1, deltaMs: 55000, cones: 0 },                     // C1 winner
    { driverId: 2, deltaMs: 58000, cones: 0 },                     // C1: round(1000*55000/58000) = 948
    { driverId: 3, deltaMs: 70000, cones: 0, disposition: "DNF" }, // CS: DNF → excluded
    { driverId: 6, deltaMs: 67000, cones: 0 },                     // CS winner (Cam DNF)
    { driverId: 7, deltaMs: 82000, cones: 0 },                     // CS: round(1000*67000/82000) = 817
  ],
);
